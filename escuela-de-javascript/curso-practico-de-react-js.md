...
`initializer`en este caso, se llama un paquete npm `create-<initializer>`, que será instalado por , y luego se ejecutará su bin principal, presumiblemente creando o actualizando y ejecutando cualquier otra operación relacionada con la inicialización.```[npx](https://docs.npmjs.com/cli/npx)``package.json```
...
![Logotipo de Babel.js](https://upload.wikimedia.org/wikipedia/commons/thumb/0/02/Babel_Logo.svg/250px-Babel_Logo.svg.png) **Babel** es un [compilador de](https://en.wikipedia.org/wiki/Compiler) [JavaScript](https://en.wikipedia.org/wiki/JavaScript) [gratuito](https://en.wikipedia.org/wiki/Free_software) y [de código](https://en.wikipedia.org/wiki/Open-source_software) [abierto](https://en.wikipedia.org/wiki/JavaScript) que se utiliza principalmente para convertir el [código ECMAScript 2015+](https://en.wikipedia.org/wiki/ECMAScript#6th_Edition_-_ECMAScript_2015) \(ES6 +\) en una versión de [JavaScript](https://en.wikipedia.org/wiki/JavaScript) compatible con versiones anteriores que pueden ejecutar los [motores JavaScript](https://en.wikipedia.org/wiki/JavaScript_engine) más antiguos . Babel es una herramienta popular para usar las funciones más nuevas del lenguaje de programación JavaScript. \[\[3\]\]\([https://en.wikipedia.org/wiki/Babel\_\(compiler\)\#cite\_note-3](https://en.wikipedia.org/wiki/Babel_%28compiler%29#cite_note-3)\)
...
**Webpack** \(estilizado **webpack** \) es un [código abierto](https://en.wikipedia.org/wiki/Open-source_software) [de JavaScript](https://en.wikipedia.org/wiki/JavaScript) módulo bundler. [\[2\]](https://en.wikipedia.org/wiki/Webpack#cite_note-2) [\[3\]](https://en.wikipedia.org/wiki/Webpack#cite_note-3) [\[4\]](https://en.wikipedia.org/wiki/Webpack#cite_note-4) [\[5\]](https://en.wikipedia.org/wiki/Webpack#cite_note-5) [\[6\]](https://en.wikipedia.org/wiki/Webpack#cite_note-6) Es un paquete de módulos principalmente para JavaScript, pero puede transformar activos front-end como HTML, CSS e imágenes si se incluyen los complementos correspondientes. [\[7\]](https://en.wikipedia.org/wiki/Webpack#cite_note-7) Webpack toma módulos con dependencias y genera activos estáticos que representan esos módulos. [\[8\]](https://en.wikipedia.org/wiki/Webpack#cite_note-8)
...
_**Nota** : Muchas opciones de CLI están disponibles con `webpack-dev-server`. Explore este_ [_enlace_](https://webpack.js.org/configuration/dev-server/) _._
